...
function preload() {
    blackLibrarianSprite = loadImage("librarian-bw.png");
    pinkLibrarianSprite = loadImage("librarian-pink.png")
}

function setup() {
    createCanvas(400,400);
    blackLibrarian = new Character(blackLibrarianSprite, 50, 100, 10);
    pinkLibrarian = new Character(pinkLibrarianSprite, 200, 100, 5);
